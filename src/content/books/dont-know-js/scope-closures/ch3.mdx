---
title: "作用域链"
description: "第 1 章和第 2 章对词汇范围（及其组成部分）进行了具体的定义，并说明了其概念基础的有用比喻。在继续本章之前，请找其他人用你自己的话（书面或大声）解释一下词汇范围是什么以及理解它为什么有用。

这似乎是你可以跳过的一步，但我发现花时间重新表述这些想法以向他人解释确实很有帮助。这有助于我们的大脑消化我们正在学习的东西！

现在是时候深入研究细节了，因此从现在开始，事情会变得更加详细。不过，请坚持下去，因为这些讨论确实让我们意识到，我们对范围的了解还有多少。请务必花时间阅读文本和提供的所有代码片段。"
